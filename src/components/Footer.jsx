    ...
    <div className='footer-public'>
      ...
      <div className="white-paper-body">
        ...
        <div className="read-whitepaper-box">
          ...
          <span className="read-whitepaper"><b>2021-2022</b></span>
        </div>
      </div>
      {/* footer */}
          ...
          <div className="footer-items">
            <div className="d-flex align-items-center flex-wrap">
              <div className="col-12 col-lg-4 px-4">
                <div className="footer-logo">
                  ...
                  <p className="text-about-footer">
                    We develop intelligent protocol ourselves, But We need your unique idea and help to achieve our goals. We invite all investors and advisors to join us and build something unique and bring financial world to the new stage.
                  </p>
              ...
              <div className="col-12 col-lg-5 px-4">
                <div className="socail-media-body">
                  <span className="title-footer">
                    Socail Media
                  </span>
                  <div className="socail-media-item">
                    <a href="https://www.linkedin.com/in/intelligent-protocol-8780a124a" target={'_blank'} className='socail-media-link'><LinkedInIcon /></a>
                    <a href="https://twitter.com/intelligent_dex?t=HVZnaphktMXbaifu4nN0cg&s=09" target={'_blank'} className='socail-media-link'><TwitterIcon /></a>
                    <a href="https://youtube.com/channel/UCuoa6kukKPiBmsoqGfL_IfA" target={'_blank'} className='socail-media-link'><YouTubeIcon /></a>
                    <a href="https://t.me/Intelligent_protocol" target={'_blank'} className='socail-media-link'><TelegramIcon /></a>
                    <a href="" className='socail-media-link'><InstagramIcon /></a>

                  </div>
                  <span className="title-socail-media">
                    We accept
                  </span>
            ...
            <div className="copy-right-box">
              ...
              <span className="copy-right"><CopyrightIcon /> 2022. All rights reserved.</span>
