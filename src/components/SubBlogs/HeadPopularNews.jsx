...
function HeadPopularNews() {
    const CaptionName={
        title:"Popular News"
    };
    return (
    <div className='w-100'>
        <div className="head-popular-news row">
            ...
            <div className="col-lg-4">
                <div className="title-Broadcasts-box text-center mb-lg-5 my-3 mu-lg-0">
...
export default HeadPopularNews