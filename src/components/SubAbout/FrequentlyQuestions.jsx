    ...
    <div className='container accordion-frequently-questions '>
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel1a-header"
        >
          <Typography>{CaptionName.titleAccordion}</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
          {CaptionName.textAccordion}
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion>
