...
function OurMission() {
    const CaptionName = {
        ...
        readRtificial:"Click the link below to read more about our artificial intelligence",
        ...
        <div className="row mt-lg-5">
          ...
          <div className="col-12">
            <div className="text-extra-mission-box">
              ...
              <a href="" className='read-rtificial w-100 text-center text-lg-start'>
