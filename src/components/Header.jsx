    ...
    <header className='header-public'>
        <div className="container">
            <div className="navbar-item">
                    ...
                    <ul className='links meno-collapsed'>
                        <li>
                    ...
                    <button className='btn-navbar-search '>
                        <SearchIcon/>
                    </button>
                    ...
                    <button href="" className='btn-down-white-paper'>
                        <img src={DownloadIcon} alt="download icon" /> downlaod white paper
                    </button>
